...
namespace DataControl.Utils
{
    ...
    public static class UserActions
    {
        ...
        public static bool DeleteUser(int UserId, ref string err)
        {
            if (Constants.SessionUser.IsAdmin)
            {
                ...
                try
                {
                    using (var context = new OPDdbContext())
                    {
                        User u = context.Users.Single(u => u.UserID == UserId);
            ...
            {
                err = "You don't have permissions to delete users";
                return false;
            }
        }
